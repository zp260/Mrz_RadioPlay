...
- (void)viewDidLoad {
    ...
    HomeTab.tabBar.frame=CGRectMake(0, KNavgationBarHeight, kDeviceWidth, KTabarHeight+50);
    HomeTab.tabBar.backgroundColor=[UIColor clearColor];
    HomeTab.tabBar.tintColor=[UIColor colorWithRed:251.0f/255.0f green:87.0f/255.0f blue:49.0f/255.0f alpha:1.0f];
    NSLog(@"%i,%i",(int)HomeTab.tabBar.frame.size.height,(int)HomeTab.tabBar.frame.size.width);
    //Tabbar页面1
